...
export type RouteRequiredParams<TRouteDescription extends RouteDescription> = PathRequiredParams<
    PathPatternOf<TRouteDescription>
>;
export type RouteOptionalParams<TRouteDescription extends RouteDescription> = PathOptionalParams<
    PathPatternOf<TRouteDescription>
>;
export type RouteRequiredQuery<TRouteDescription extends RouteDescription> = PathRequiredQuery<
    PathPatternOf<TRouteDescription>
>;
export type RouteOptionalQuery<TRouteDescription extends RouteDescription> = PathOptionalQuery<
    PathPatternOf<TRouteDescription>
>;
